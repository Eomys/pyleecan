...
slotWLSRPM_test = list()

lam = LamSlot(is_internal=False, Rint=50.7 * 1e-3, Rext=72.5 * 1e-3,)
lam.slot = SlotWLSRPM(Zs=12, W1=8e-3, W3=11.6e-3, H2=14.8e-3, R1=0.75e-3, H3=1e-3)
slotWLSRPM_test.append(
    {
        "test_obj": lam,
        "S_exp": 3.9258746e-4,
        "Aw": 0.1044713,
...
class Test_SlotWLSRPM_meth(object):
    """pytest for SlotWLSRPM methods"""

    @pytest.mark.parametrize("test_dict", slotWLSRPM_test)
