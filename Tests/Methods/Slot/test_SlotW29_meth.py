...
class Test_SlotW29_meth(object):
    ...
    def test_build_geometry(self):
        ...
        for i in range(0, len(result)):
            ...
            assert abs((a - b) / a-0) < DELTA, "Wrong build_geo (for begin point " + str(i) + " returned " + str(a) + ", expected " + str(b) + ")"


            a = result[i].end
            b = curve_list[i].end
            assert abs((a - b) / a-0) < DELTA, "Wrong build_geo (for end point " + str(i) + " returned " + str(a) + ", expected " + str(b) + ")"
