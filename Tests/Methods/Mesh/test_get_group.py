...
class unittest_get_group(TestCase):
    ...
    def setUp(self):
        ...
        mesh.point = PointMat()
        mesh.point.add_node(np.array([0, 0]))
        mesh.point.add_node(np.array([1, 0]))
        mesh.point.add_node(np.array([1, 2]))
        mesh.point.add_node(np.array([2, 3]))
        mesh.point.add_node(np.array([3, 3]))
