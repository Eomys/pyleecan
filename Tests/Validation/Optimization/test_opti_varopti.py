...
def test_opti_varopti():
    ...
    simu_ref.var_simu = VarOpti(paramexplorer_list=my_design_var, objective_list=my_obj, constraint_list=my_constraint, solver=solver, var_simu=simu_ref.var_simu)
