...
class TestSMHoleMag(object):
    ...
    def test_init(self):
        ...
        assert self.widget.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 50"
    ...
    def test_init_SyRM(self):
        ...
        assert self.widget2.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 54"
    ...
    def test_init_SyRM_51(self):
        ...
        assert self.widget2.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 51"
        assert self.widget2.tab_hole.widget(0).c_hole_type.count() == 7
    ...
    def test_init_51(self):
        ...
        self.widget = SMHoleMag(    machine=self.test_obj, matlib=self.matlib, is_stator=False    )
        ...
        assert self.widget.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 51"
    ...
    def test_init_52(self):
        ...
        assert self.widget.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 52"
    ...
    def test_init_53(self):
        ...
        assert self.widget.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 53"
    ...
    def test_init_57(self):
        ...
        assert self.widget.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 57"
    ...
    def test_init_58(self):
        ...
        assert self.widget.tab_hole.widget(0).c_hole_type.currentText() == "Slot Type 58"
