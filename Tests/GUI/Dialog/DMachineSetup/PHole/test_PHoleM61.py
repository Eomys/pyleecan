...
from pyleecan.GUI.Dialog.DMachineSetup.SMHoleMag.PHoleM61.PHoleM61 import PHoleM61


class TestPHoleM61(object):
    """Test that the widget PHoleM61 behave like it should"""

    @classmethod
    def setup_class(cls):
        """Start the app for the test"""
        print("\nStart Test TestPHoleM61")
    ...
    def test_init(self):
        ...
        assert self.widget.lf_H2.value() == 0.18
        ...
        self.test_obj.hole[0] = HoleM61(
            H0=0.21, H1=0.22, H2=0.18, W0=0.23, W1=0.24, W2=0.25, W3=0.27
        )
        self.widget = PHoleM61(self.test_obj.hole[0], self.material_dict)
