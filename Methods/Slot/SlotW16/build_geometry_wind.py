...
def build_geometry_wind(self, Nrad, Ntan, is_simplified=False, alpha=0, delta=0):
    ...
    if Nrad == 1 and Ntan == 2:
        if is_simplified:
            # Part 1 (0,0)
            line1 = Arc1(Z6, Ztan2, -Rbo + self.H0 + self.H2)
            ...
            line1 = Arc1(Ztan2, Z5, -Rbo + self.H0 + self.H2)
            ...
            # Part 1 (0,0)
            line1 = Arc1(Ztan1, Z8, Rbo - self.H0)
            line2 = Arc1(Z8, Z7, self.R1)
            line3 = Segment(Z7, Z6)
            line4 = Arc1(Z6, Ztan2, -Rbo + self.H0 + self.H2)
            ...
            line1 = Arc1(Z3, Ztan1, Rbo - self.H0)
            line2 = Segment(Ztan1, Ztan2)
            line3 = Arc1(Ztan2, Z5, -Rbo + self.H0 + self.H2)
            line4 = Segment(Z5, Z4)
            line5 = Arc1(Z4, Z3, self.R1)
            point_ref = (Z3 + Ztan1 + Ztan2 + Z5 + Z4) / 5
        ...
        if is_simplified:
            ...
            # Part2 (1,0)
            line1 = Arc1(Z6, Z5, -Rbo + self.H0 + self.H2)
            ...
            line2 = Arc1(Z6, Z5, -Rbo + self.H0 + self.H2)
        ...
        if is_simplified:
            ...
            line3 = Arc1(Z6, Ztan2, -Rbo + self.H0 + self.H2)
        ...
        lines = [Arc1(curve_list[-1].end, curve_list[0].begin, -Rbo + self.H0)]
