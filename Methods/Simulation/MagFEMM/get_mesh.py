...
def get_mesh(self, is_get_mesh, is_save_FEA, save_path, j_t0):
    ...
    path_node = join(save_path, 'nodes' + idlab + '.txt')
    path_element = join(save_path, 'elements' + idlab + '.txt')
    ...
    path_results = join(save_path, 'results' + idlab + '.txt')
