...
def test_ElecLUTdq_solve_MTPA():
    ...
    machine = load(
        "C:/Users/LAP24/Documents/Consulting/MANATEE/Stellantis/pyManatee/Consulting/machine/Stellantis_IPMSM_test_doubleV.json"
    )
    ...
    simu = Simu1(name="stel_2Vshape_MTPA_proj", machine=machine)
