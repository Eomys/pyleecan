...
if __name__ == "__main__":
    ...
    Phi_A = 0.5*np.cos(50.0 * 2.0*np.pi*time)+0.001*np.cos(100 * 2.0*np.pi*time)+0.0009*np.cos(150 * 2.0*np.pi*time)
    Phi_B = 0.5*np.cos(50.0 * 2.0*np.pi*time-2*pi/3)+0.001*np.cos(100 * 2.0*np.pi*time-2*pi/3)+0.0009*np.cos(150 * 2.0*np.pi*time-2*pi/3)
    Phi_C = 0.5*np.cos(50.0 * 2.0*np.pi*time+2*pi/3)+0.001*np.cos(100 * 2.0*np.pi*time+2*pi/3)+0.0009*np.cos(150 * 2.0*np.pi*time+2*pi/3)
    delta=50.0 * 2.0*np.pi*time
    
    E_d, E_q, E_h, freqs_d, freqs_q, freqs_h=comp_BEMF_harmonics(Phi_A=Phi_A, Phi_B=Phi_B, Phi_C=Phi_C,delta=delta, time=time)
