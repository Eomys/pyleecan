...
def plot_schematics(
    ...
    if is_default:
        ...
        if is_add_schematics:
            # H0
            line = Segment(
                point_dict["Z1"] * exp(1j * sp),
                point_dict["Z2"] * exp(1j * sp),
            )
            line.plot(
                fig=fig,
                ax=ax,
            ...
            # H1
            line = Segment(
                (point_dict["Z11"] + point_dict["Z2"]) / 2,
            ...
            line.plot(
                ...
                linewidth=ARROW_WIDTH,
                label="H1",
                offset_label=self.W0 * 0.5 + 1j * self.W0 * 0.4,
                is_arrow=True,
                fontsize=SC_FONT_SIZE,
            )
            ...
            # W3
            line = Segment(point_dict["Z8"], point_dict["Z5"] * exp(1j * sp))
            line.plot(
                fig=fig,
                ax=ax,
                color=ARROW_COLOR,
            ...
            # W0
            line = Segment(
                point_dict["Z12"] * exp(-1j * sp), point_dict["Z1"] * exp(-1j * sp)
            )
            line.plot(
                fig=fig,
                ax=ax,
                ...
                linewidth=ARROW_WIDTH,
                label="W0",
                offset_label=self.W0 * 0.4 - self.W0 * 0.3 * 1j,
                is_arrow=True,
                fontsize=SC_FONT_SIZE,
            )
        ...
        if is_add_main_line:
            ...
            # R2 lines
            line = Segment(point_dict["Z5"], point_dict["Zc2"])
            line.plot(
                fig=fig,
                ax=ax,
                color=MAIN_LINE_COLOR,
            ...
            line = Segment(point_dict["Z6"], point_dict["Zc2"])
            line.plot(
                fig=fig,
                ax=ax,
                color=MAIN_LINE_COLOR,
            ...
            line = Segment(point_dict["Z9"], point_dict["Z4"] * exp(1j * sp))
            line.plot(
                fig=fig,
                ax=ax,
                color=MAIN_LINE_COLOR,
        ...
        W = (point_dict["Z7"] * exp(1j * sp)).imag * 1
