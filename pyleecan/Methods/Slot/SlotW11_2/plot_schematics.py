...
def plot_schematics(
    ...
    if is_default:
        slot = type(self)(
            Zs=8, H0=10e-3, W0=20e-3, H1=10e-3, H2=40e-3, W1=40e-3, W2=20e-3, R1=5e-3
        )
        lam = LamSlot(
        ...
        if is_add_schematics:
            ...
            # W2
            Zlim1 = point_dict["Z5"].real + sign * self.R1 + 1j * point_dict["Z4c"].imag
            Zlim2 = point_dict["Z6"].real + sign * self.R1 + 1j * point_dict["Z7c"].imag
            plot_quote(
                point_dict["Z4c"],
                Zlim1,
                Zlim2,
