...
def add_rule_rectangular_duct_trapeze(self, is_stator, duct_id):
    ...
    self.rules_list.append(
        RuleSimple(
            other_key_list=[
                "[Dimensions]",
                f"{lam_name}RectangularDuctlayers_RadialDiameter[{duct_id}]",
            ],
    ...
    self.rules_list.append(
        RuleSimple(
            other_key_list=[
                "[Dimensions]",
                f"{lam_name}RectangularDuctLayer_OffsetAngle[{duct_id}]",
            ],
    ...
    self.rules_list.append(
        RuleSimple(
            other_key_list=[
                "[Dimensions]",
                f"{lam_name}RectangularDuctLayer_ChannelDiameter[{duct_id}]",
            ],
    ...
    self.rules_list.append(
        RuleSimple(
            other_key_list=[
                "[Dimensions]",
                f"{lam_name}RectangularDuctLayer_Channels[{duct_id}]",
            ],
    ...
    self.rules_list.append(
        RuleSimple(
            other_key_list=[
                "[Dimensions]",
                f"{lam_name}RectangularDuctLayer_Width[{duct_id}]",
            ],
    ...
    self.rules_list.append(
        RuleSimple(
            ...
            P_obj_path=f"machine.{lam_name}.axial_vent[{duct_id}].W2",
            unit_type="m",
            scaling_to_P=1,
            file_name=__file__,
        )
