...
class SlotW23(Slot):
    ...
    def __init__(self, W0=0.003, H0=0.003, H1=0, W1=0.013, H2=0.02, W2=0.01, W3=0.01, H1_is_rad=False, is_cstt_tooth=False, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from Slot
        diff_list.extend(super(SlotW23, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._is_cstt_tooth != self._is_cstt_tooth:
            if is_add_value:
                val_str = ' (self='+str(self._is_cstt_tooth)+', other='+str(other._is_cstt_tooth)+')'
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from Slot
        SlotW23_dict = super(SlotW23, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,H1=H1_val,W1=W1_val,H2=H2_val,W2=W2_val,W3=W3_val,H1_is_rad=H1_is_rad_val,is_cstt_tooth=is_cstt_tooth_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy
