...
class ImportData(FrozenClass):
    ...
    def as_dict(self):
        ...
        ImportData_dict["normalizations"] = self.normalizations.copy() if self.normalizations is not None else None
        ImportData_dict["symmetries"] = self.symmetries.copy() if self.symmetries is not None else None
