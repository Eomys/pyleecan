...
class SlotW24(Slot):
    ...
    def __init__(
        self, W3=0.003, H2=0.003, Zs=36, wedge_mat=None, init_dict=None, init_str=None
    ):
        ...
        self.H2 = H2
        # Call Slot init
        super(SlotW24, self).__init__(Zs=Zs, wedge_mat=wedge_mat)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W3=W3_val, H2=H2_val, Zs=Zs_val, wedge_mat=wedge_mat_val)
        return obj_copy
