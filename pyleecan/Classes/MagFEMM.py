...
class MagFEMM(Magnetics):
    ...
    def __str__(self):
        ...
        MagFEMM_str += "is_get_meshsolution = " + str(self.is_get_meshsolution) + linesep
        MagFEMM_str += "is_save_meshsolution_as_file = " + str(self.is_save_meshsolution_as_file) + linesep
        ...
        MagFEMM_str += "is_calc_torque_energy = " + str(self.is_calc_torque_energy) + linesep
        return MagFEMM_str
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from Magnetics
        diff_list.extend(super(MagFEMM, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._type_calc_leakage != self._type_calc_leakage:
            if is_add_value:
                val_str = ' (self='+str(self._type_calc_leakage)+', other='+str(other._type_calc_leakage)+')'
        ...
        if other._FEMM_dict_enforced != self._FEMM_dict_enforced:
            if is_add_value:
                val_str = ' (self='+str(self._FEMM_dict_enforced)+', other='+str(other._FEMM_dict_enforced)+')'
        ...
        if other._is_save_meshsolution_as_file != self._is_save_meshsolution_as_file:
            if is_add_value:
                val_str = ' (self='+str(self._is_save_meshsolution_as_file)+', other='+str(other._is_save_meshsolution_as_file)+')'
        ...
        if other._is_sliding_band != self._is_sliding_band:
            if is_add_value:
                val_str = ' (self='+str(self._is_sliding_band)+', other='+str(other._is_sliding_band)+')'
        ...
        if other._is_close_femm != self._is_close_femm:
            if is_add_value:
                val_str = ' (self='+str(self._is_close_femm)+', other='+str(other._is_close_femm)+')'
        ...
        if other._Rag_enforced is not None and self._Rag_enforced is not None and isnan(other._Rag_enforced) and isnan(self._Rag_enforced):
            pass
        elif other._Rag_enforced != self._Rag_enforced:
            if is_add_value:
                val_str = ' (self='+str(self._Rag_enforced)+', other='+str(other._Rag_enforced)+')'
        ...
        if other._is_set_previous != self._is_set_previous:
            if is_add_value:
                val_str = ' (self='+str(self._is_set_previous)+', other='+str(other._is_set_previous)+')'
        ...
        if other._is_fast_draw != self._is_fast_draw:
            if is_add_value:
                val_str = ' (self='+str(self._is_fast_draw)+', other='+str(other._is_fast_draw)+')'
        ...
        if other._is_calc_torque_energy != self._is_calc_torque_energy:
            if is_add_value:
                val_str = ' (self='+str(self._is_calc_torque_energy)+', other='+str(other._is_calc_torque_energy)+')'
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from Magnetics
        MagFEMM_dict = super(MagFEMM, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        ...
        MagFEMM_dict["FEMM_dict_enforced"] = (
            self.FEMM_dict_enforced.copy() if self.FEMM_dict_enforced is not None else None
        )
        ...
        if self.rotor_dxf is None:
            ...
            MagFEMM_dict["rotor_dxf"] = self.rotor_dxf.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        if self.stator_dxf is None:
            MagFEMM_dict["stator_dxf"] = None
        else:
            MagFEMM_dict["stator_dxf"] = self.stator_dxf.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
