...
try:
    from ..Methods.Simulation.Subdomain_Airgap.add_constants_numbers import (
...
class Subdomain_Airgap(Subdomain):
    ...
    # cf Methods.Simulation.Subdomain_Airgap.add_constants_numbers
    if isinstance(add_constants_numbers, ImportError):
        add_constants_numbers = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use Subdomain_Airgap method add_constants_numbers: "
