...
class HoleM52R(HoleMag):
    ...
    def __init__(self, H0=0.003, W0=0.003, H1=0, W1=0.001, H2=0.02, magnet_0=-1, R0=0, Zh=36, mat_void=-1, magnetization_dict_offset=None, Alpha0=0, init_dict = None, init_str = None):
        ...
        self.R0 = R0
        # Call HoleMag init
        super(HoleM52R, self).__init__(Zh=Zh, mat_void=mat_void, magnetization_dict_offset=magnetization_dict_offset, Alpha0=Alpha0)
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from HoleMag
        diff_list.extend(super(HoleM52R, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from HoleMag
        HoleM52R_dict = super(HoleM52R, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        ...
        if self.magnet_0 is None:
            ...
            HoleM52R_dict["magnet_0"] = self.magnet_0.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(H0=H0_val,W0=W0_val,H1=H1_val,W1=W1_val,H2=H2_val,magnet_0=magnet_0_val,R0=R0_val,Zh=Zh_val,mat_void=mat_void_val,magnetization_dict_offset=magnetization_dict_offset_val,Alpha0=Alpha0_val)
        return obj_copy
