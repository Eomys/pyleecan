# -*- coding: utf-8 -*-
# File generated according to Generator/ClassesRef/Simulation/LossModelProximity.csv
# WARNING! All changes made in this file will be lost!
"""Method code available at https://github.com/Eomys/pyleecan/tree/master/pyleecan/Methods/Simulation/LossModelProximity
"""
...
try:
    from ..Methods.Simulation.LossModelProximity.comp_coeff import comp_coeff
except ImportError as error:
    comp_coeff = error

try:
    from ..Methods.Simulation.LossModelProximity.comp_loss import comp_loss
except ImportError as error:
    comp_loss = error
...
class LossModelProximity(LossModel):
    ...
    # cf Methods.Simulation.LossModelProximity.comp_coeff
    ...
    # cf Methods.Simulation.LossModelProximity.comp_loss
