...
class HoleM50(HoleMag):
    ...
    def __init__(self, H0=0.003, W0=0.003, H1=0, W1=0.013, H2=0.02, W2=0.01, H3=0.01, W3=0.01, H4=0, W4=0.01, magnet_0=-1, magnet_1=-1, Zh=36, mat_void=-1, magnetization_dict_offset=None, Alpha0=0, init_dict = None, init_str = None):
        ...
        # Call HoleMag init
        super(HoleM50, self).__init__(Zh=Zh, mat_void=mat_void, magnetization_dict_offset=magnetization_dict_offset, Alpha0=Alpha0)
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from HoleMag
        diff_list.extend(super(HoleM50, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._H4 is not None and self._H4 is not None and isnan(other._H4) and isnan(self._H4):
            pass
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from HoleMag
        HoleM50_dict = super(HoleM50, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        ...
        if self.magnet_0 is None:
            ...
            HoleM50_dict["magnet_0"] = self.magnet_0.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        if self.magnet_1 is None:
            HoleM50_dict["magnet_1"] = None
        else:
            HoleM50_dict["magnet_1"] = self.magnet_1.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(H0=H0_val,W0=W0_val,H1=H1_val,W1=W1_val,H2=H2_val,W2=W2_val,H3=H3_val,W3=W3_val,H4=H4_val,W4=W4_val,magnet_0=magnet_0_val,magnet_1=magnet_1_val,Zh=Zh_val,mat_void=mat_void_val,magnetization_dict_offset=magnetization_dict_offset_val,Alpha0=Alpha0_val)
        return obj_copy
