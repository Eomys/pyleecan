...
class ModelBH_Langevin(ModelBH):
    ...
    def __init__(self, Bs=None, a=None, param1=1.89, param2=240, Bmax=2.31, Hmax=None, delta=100, init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from ModelBH
        diff_list.extend(super(ModelBH_Langevin, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from ModelBH
        ModelBH_Langevin_dict = super(ModelBH_Langevin, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(Bs=Bs_val,a=a_val,param1=param1_val,param2=param2_val,Bmax=Bmax_val,Hmax=Hmax_val,delta=delta_val)
        return obj_copy
