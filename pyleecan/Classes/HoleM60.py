# -*- coding: utf-8 -*-
# File generated according to Generator/ClassesRef/Slot/HoleM60.csv
# WARNING! All changes made in this file will be lost!
"""Method code available at https://github.com/Eomys/pyleecan/tree/master/pyleecan/Methods/Slot/HoleM60
"""
...
try:
    from ..Methods.Slot.HoleM60._comp_point_coordinate import _comp_point_coordinate
except ImportError as error:
    _comp_point_coordinate = error

try:
    from ..Methods.Slot.HoleM60.build_geometry import build_geometry
except ImportError as error:
...
class HoleM60(HoleMag):
    ...
    # cf Methods.Slot.HoleM60._comp_point_coordinate
    if isinstance(_comp_point_coordinate, ImportError):
        _comp_point_coordinate = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use HoleM60 method _comp_point_coordinate: "
    ...
    # cf Methods.Slot.HoleM60.build_geometry
    if isinstance(build_geometry, ImportError):
        build_geometry = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use HoleM60 method build_geometry: " + str(build_geometry)
                )
            )
        )
    else:
    ...
    def __init__(self, W0=None, W1=None, W2=None, W3=None, H0=None, H1=None, Zh=36, mat_void=-1, magnetization_dict_offset=None, Alpha0=0, init_dict = None, init_str = None):
    ...
    def __str__(self):
        ...
        HoleM60_str += super(HoleM60, self).__str__()
        HoleM60_str += "W0 = " + str(self.W0) + linesep
        HoleM60_str += "W1 = " + str(self.W1) + linesep
        HoleM60_str += "W2 = " + str(self.W2) + linesep
        HoleM60_str += "W3 = " + str(self.W3) + linesep
        HoleM60_str += "H0 = " + str(self.H0) + linesep
    ...
    def __eq__(self, other):
        ...
        if not super(HoleM60, self).__eq__(other):
            return False
        if other.W0 != self.W0:
            return False
        if other.W1 != self.W1:
    ...
    def __sizeof__(self):
        ...
        S += super(HoleM60, self).__sizeof__()
        S += getsizeof(self.W0)
        S += getsizeof(self.W1)
        S += getsizeof(self.W2)
        S += getsizeof(self.W3)
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        HoleM60_dict["W3"] = self.W3
        HoleM60_dict["H0"] = self.H0
        HoleM60_dict["H1"] = self.H1
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,W1=W1_val,W2=W2_val,W3=W3_val,H0=H0_val,H1=H1_val,Zh=Zh_val,mat_void=mat_void_val,magnetization_dict_offset=magnetization_dict_offset_val,Alpha0=Alpha0_val)
        return obj_copy
