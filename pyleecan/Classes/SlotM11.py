...
try:
    from ..Methods.Slot.SlotM11.is_airgap_active import is_airgap_active
except ImportError as error:
    is_airgap_active = error

try:
    from ..Methods.Slot.SlotM11.is_full_pitch_active import is_full_pitch_active
except ImportError as error:
...
class SlotM11(Slot):
    ...
    # cf Methods.Slot.SlotM11.is_airgap_active
    if isinstance(is_airgap_active, ImportError):
        is_airgap_active = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use SlotM11 method is_airgap_active: "
    ...
    # cf Methods.Slot.SlotM11.is_full_pitch_active
    if isinstance(is_full_pitch_active, ImportError):
        is_full_pitch_active = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use SlotM11 method is_full_pitch_active: "
