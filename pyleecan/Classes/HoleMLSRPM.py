...
try:
    from ..Methods.Slot.HoleMLSRPM.comp_magnetization_dict import comp_magnetization_dict
except ImportError as error:
...
class HoleMLSRPM(HoleMag):
    ...
    def __init__(self, H1=0.002373479, W0=0.00388, W1=0.219911482, W2=0.0007, R1=0.0003, R2=0.019327, R3=0.0165, magnet_0=-1, Zh=36, mat_void=-1, magnetization_dict_offset=None, Alpha0=0, init_dict = None, init_str = None):
        ...
        # Call HoleMag init
        super(HoleMLSRPM, self).__init__(Zh=Zh, mat_void=mat_void, magnetization_dict_offset=magnetization_dict_offset, Alpha0=Alpha0)
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from HoleMag
        diff_list.extend(super(HoleMLSRPM, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._R3 is not None and self._R3 is not None and isnan(other._R3) and isnan(self._R3):
            pass
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from HoleMag
        HoleMLSRPM_dict = super(HoleMLSRPM, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        ...
        if self.magnet_0 is None:
            ...
            HoleMLSRPM_dict["magnet_0"] = self.magnet_0.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(H1=H1_val,W0=W0_val,W1=W1_val,W2=W2_val,R1=R1_val,R2=R2_val,R3=R3_val,magnet_0=magnet_0_val,Zh=Zh_val,mat_void=mat_void_val,magnetization_dict_offset=magnetization_dict_offset_val,Alpha0=Alpha0_val)
        return obj_copy
