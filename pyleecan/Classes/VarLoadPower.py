# -*- coding: utf-8 -*-
# File generated according to Generator/ClassesRef/Simulation/VarLoadPower.csv
# WARNING! All changes made in this file will be lost!
"""Method code available at https://github.com/Eomys/pyleecan/tree/master/pyleecan/Methods/Simulation/VarLoadPower
"""
...
try:
    from ..Methods.Simulation.VarLoadPower.generate_simulation_list import (
...
try:
    from ..Methods.Simulation.VarLoadPower.get_input_list import get_input_list
except ImportError as error:
...
class VarLoadPower(VarLoad):
    """Generate a multisimulation with InputPower at variable operating point"""

    VERSION = 1

    # Check ImportError to remove unnecessary dependencies in unused method
    # cf Methods.Simulation.VarLoadPower.generate_simulation_list
    if isinstance(generate_simulation_list, ImportError):
        generate_simulation_list = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use VarLoadPower method generate_simulation_list: "
    ...
    # cf Methods.Simulation.VarLoadPower.get_input_list
    if isinstance(get_input_list, ImportError):
        get_input_list = property(
            fget=lambda x: raise_(
                ImportError(
                    "Can't use VarLoadPower method get_input_list: "
                    + str(get_input_list)
                )
            )
        )
    ...
    def __init__(
        ...
        # Call VarLoad init
        super(VarLoadPower, self).__init__(
            OP_matrix=OP_matrix,
    ...
    def __str__(self):
        ...
        VarLoadPower_str += super(VarLoadPower, self).__str__()
        return VarLoadPower_str
    ...
    def __eq__(self, other):
        ...
        if not super(VarLoadPower, self).__eq__(other):
            return False
        return True
    ...
    def compare(self, other, name="self", ignore_list=None):
        ...
        # Check the properties inherited from VarLoad
        diff_list.extend(super(VarLoadPower, self).compare(other, name=name))
    ...
    def __sizeof__(self):
        ...
        S += super(VarLoadPower, self).__sizeof__()
        return S
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from VarLoad
        VarLoadPower_dict = super(VarLoadPower, self).as_dict(
        ...
        VarLoadPower_dict["__class__"] = "VarLoadPower"
        return VarLoadPower_dict

    def _set_None(self):
        """Set all the properties to None (except pyleecan object)"""

        # Set to None the properties inherited from VarLoad
        super(VarLoadPower, self)._set_None()
