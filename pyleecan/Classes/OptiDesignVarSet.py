...
class OptiDesignVarSet(OptiDesignVar):
    ...
    def __init__(self, space=[0, 1], get_value=None, name="", symbol="", unit="", setter=None, getter=None, init_dict = None, init_str = None):
        ...
        super(OptiDesignVarSet, self).__init__(space=space, get_value=get_value, name=name, symbol=symbol, unit=unit, setter=setter, getter=getter)
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from OptiDesignVar
        diff_list.extend(super(OptiDesignVarSet, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from OptiDesignVar
        OptiDesignVarSet_dict = super(OptiDesignVarSet, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
