...
class SlotM15(Slot):
    ...
    def __init__(self, W0=0.0122, H0=0.001, Wmag=0.0122, Hmag=0.001, Rtopm=0.001, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from Slot
        diff_list.extend(super(SlotM15, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._Wmag is not None and self._Wmag is not None and isnan(other._Wmag) and isnan(self._Wmag):
            pass
        elif other._Wmag != self._Wmag:
            if is_add_value:
                val_str = ' (self='+str(self._Wmag)+', other='+str(other._Wmag)+')'
        ...
        if other._Rtopm is not None and self._Rtopm is not None and isnan(other._Rtopm) and isnan(self._Rtopm):
            pass
        elif other._Rtopm != self._Rtopm:
            if is_add_value:
                val_str = ' (self='+str(self._Rtopm)+', other='+str(other._Rtopm)+')'
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from Slot
        SlotM15_dict = super(SlotM15, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,Wmag=Wmag_val,Hmag=Hmag_val,Rtopm=Rtopm_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy
