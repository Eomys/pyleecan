...
class SlotDC(Slot):
    ...
    def __init__(self, W1=0.0122, H1=0.0122, D1=0.001, W2=0.0122, H2=0.001, D2=0.001, H3=0.001, R3=0.001, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from Slot
        diff_list.extend(super(SlotDC, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._D1 is not None and self._D1 is not None and isnan(other._D1) and isnan(self._D1):
            pass
        ...
        if other._D2 is not None and self._D2 is not None and isnan(other._D2) and isnan(self._D2):
            pass
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from Slot
        SlotDC_dict = super(SlotDC, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W1=W1_val,H1=H1_val,D1=D1_val,W2=W2_val,H2=H2_val,D2=D2_val,H3=H3_val,R3=R3_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy
