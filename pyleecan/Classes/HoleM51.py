...
class HoleM51(HoleMag):
    ...
    def __init__(self, H0=0.003, H1=0, H2=0.02, W0=0.01, W1=0, W2=0.01, W3=0, W4=0.01, W5=0.01, W6=0, W7=0, magnet_0=-1, magnet_1=-1, magnet_2=-1, Zh=36, mat_void=-1, magnetization_dict_offset=None, Alpha0=0, init_dict = None, init_str = None):
        ...
        # Call HoleMag init
        super(HoleM51, self).__init__(Zh=Zh, mat_void=mat_void, magnetization_dict_offset=magnetization_dict_offset, Alpha0=Alpha0)
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from HoleMag
        diff_list.extend(super(HoleM51, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._W4 is not None and self._W4 is not None and isnan(other._W4) and isnan(self._W4):
            pass
        ...
        if other._W5 is not None and self._W5 is not None and isnan(other._W5) and isnan(self._W5):
            pass
        ...
        if other._W6 is not None and self._W6 is not None and isnan(other._W6) and isnan(self._W6):
            pass
        ...
        if other._W7 is not None and self._W7 is not None and isnan(other._W7) and isnan(self._W7):
            pass
        ...
        if (other.magnet_2 is None and self.magnet_2 is not None) or (other.magnet_2 is not None and self.magnet_2 is None):
            diff_list.append(name+'.magnet_2 None mismatch')
        elif self.magnet_2 is not None:
            diff_list.extend(self.magnet_2.compare(other.magnet_2,name=name+'.magnet_2',ignore_list=ignore_list,is_add_value=is_add_value))
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from HoleMag
        HoleM51_dict = super(HoleM51, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        ...
        if self.magnet_0 is None:
            ...
            HoleM51_dict["magnet_0"] = self.magnet_0.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        if self.magnet_1 is None:
            HoleM51_dict["magnet_1"] = None
        else:
            HoleM51_dict["magnet_1"] = self.magnet_1.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
        if self.magnet_2 is None:
            HoleM51_dict["magnet_2"] = None
        else:
            HoleM51_dict["magnet_2"] = self.magnet_2.as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(H0=H0_val,H1=H1_val,H2=H2_val,W0=W0_val,W1=W1_val,W2=W2_val,W3=W3_val,W4=W4_val,W5=W5_val,W6=W6_val,W7=W7_val,magnet_0=magnet_0_val,magnet_1=magnet_1_val,magnet_2=magnet_2_val,Zh=Zh_val,mat_void=mat_void_val,magnetization_dict_offset=magnetization_dict_offset_val,Alpha0=Alpha0_val)
        return obj_copy
    ...
    def _set_magnet_2(self, value):
        ...
        if isinstance(value, str):  # Load from file
            try:
                ...
                value = None
        if isinstance(value, dict) and '__class__' in value:
            class_obj = import_class('pyleecan.Classes', value.get('__class__'), 'magnet_2')
            value = class_obj(init_dict=value)
        elif type(value) is int and value == -1:  # Default constructor
