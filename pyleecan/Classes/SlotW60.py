...
class SlotW60(Slot):
    ...
    def __init__(self, W1=0.02, W2=0.03, H1=0.05, H2=0.15, R1=0.03, H3=0, H4=0, W3=0, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from Slot
        diff_list.extend(super(SlotW60, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from Slot
        SlotW60_dict = super(SlotW60, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W1=W1_val,W2=W2_val,H1=H1_val,H2=H2_val,R1=R1_val,H3=H3_val,H4=H4_val,W3=W3_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy
