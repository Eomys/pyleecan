...
class InputCurrent(Input):
    ...
    def __init__(self, Is=None, Ir=None, angle_rotor=None, N0=None, rot_dir=None, angle_rotor_initial=0, Tem_av_ref=None, Id_ref=None, Iq_ref=None, felec=None, time=None, angle=None, Nt_tot=2048, Nrev=1, Na_tot=2048, init_dict = None, init_str = None):
