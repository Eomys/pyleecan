...
class Slot19(Slot):
    ...
    def __init__(self, W0=0.013, H0=0.02, W1=0.01, Wx_is_rad=False, Zs=36, wedge_mat=None, is_bore=True, init_dict = None, init_str = None):
    ...
    def compare(self, other, name='self', ignore_list=None, is_add_value=False):
        ...
        # Check the properties inherited from Slot
        diff_list.extend(super(Slot19, self).compare(other,name=name, ignore_list=ignore_list, is_add_value=is_add_value))
        ...
        if other._Wx_is_rad != self._Wx_is_rad:
            if is_add_value:
                val_str = ' (self='+str(self._Wx_is_rad)+', other='+str(other._Wx_is_rad)+')'
    ...
    def as_dict(self, type_handle_ndarray=0, keep_function=False, **kwargs):
        ...
        # Get the properties inherited from Slot
        Slot19_dict = super(Slot19, self).as_dict(type_handle_ndarray=type_handle_ndarray, keep_function=keep_function, **kwargs)
    ...
    def copy(self):
        ...
        obj_copy = type(self)(W0=W0_val,H0=H0_val,W1=W1_val,Wx_is_rad=Wx_is_rad_val,Zs=Zs_val,wedge_mat=wedge_mat_val,is_bore=is_bore_val)
        return obj_copy
