...
class InputElec(Input):
    ...
    def __init__(self, N0=None, rot_dir=-1, Id_ref=None, Iq_ref=None, Ud_ref=None, Uq_ref=None, felec=None, time=None, angle=None, Nt_tot=2048, Nrev=1, Na_tot=2048, init_dict = None, init_str = None):
