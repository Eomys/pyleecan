...
class Gen_DMatSetup(Ui_DMatSetup):
    def setupUi(self, DMatSetup):
        ...
        # Setup of in_name
        txt = self.tr("""name of the material""")
        ...
        txt = self.tr("""If Isotropic, uniformity in all orientations""")
        ...
        txt = self.tr("""Resistivity at 20 deg C""")
        ...
        txt = self.tr("""Thermal resistivity coefficient""")
        ...
        txt = self.tr("""Cost of one kilo of material""")
        ...
        # Setup of in_Cp
        txt = self.tr("""specific heat capacity""")
        ...
        # Setup of in_alpha
        txt = self.tr("""thermal expansion coefficient""")
        ...
        txt = self.tr("""mass per unit volume [kg/m3]""")
        ...
        # Setup of in_mur_lin
        txt = self.tr("""Relative magnetic permeability""")
        ...
        # Setup of in_Brm20
        txt = self.tr("""magnet remanence induction at 20degC""")
        ...
        txt = self.tr("""temperature coefficient for remanent flux density""")
