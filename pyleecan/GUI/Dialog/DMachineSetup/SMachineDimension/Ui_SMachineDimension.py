    ...
    def retranslateUi(self, SMachineDimension):
        ...
        self.in_SRext.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension",
                "<qt><nobr>Stator external radius</nobr></qt>",
                None,
            )
        )
        ...
        self.in_SRint.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension",
                "<qt><nobr>Stator internal radius</nobr></qt>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.in_RRext.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension",
                "<qt><nobr>Rotor external radius</nobr></qt>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.in_RRint.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension",
                "<qt><nobr>Rotor internal radius</nobr></qt>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.out_airgap.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension",
                "<qt><nobr>Magnetic airgap width (distance between stator bore and</nobr> rotor bore radii)</qt>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.out_Drsh.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension", "<qt><nobr>Shaft Diameter</nobr></qt>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lf_Lfra.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension", "<qt><nobr>Frame length</nobr></qt>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lf_Wfra.setToolTip(
            QCoreApplication.translate(
                "SMachineDimension", "<qt><nobr>Frame width</nobr></qt>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(whatsthis)
