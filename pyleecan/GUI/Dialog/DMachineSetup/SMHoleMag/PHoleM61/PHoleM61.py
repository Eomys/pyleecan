...
from pyleecan.GUI.Dialog.DMachineSetup.SMHoleMag.PHoleM61.Gen_PHoleM61 import (
    Gen_PHoleM61,
)
...
class PHoleM61(Gen_PHoleM61, QWidget):
    """Page to set the Hole Type 61"""

    # Signal to DMachineSetup to know that the save popup is needed
    saveNeeded = Signal()
    # Information for WHoleMag
    hole_name = "Hole Type 61"
    hole_type = HoleM61
    ...
    def __init__(self, hole=None, material_dict=None):
        ...
        self.w_mat_4.setText("mat_void")
        self.w_mat_4.def_mat = "Air"
        self.w_mat_4.is_hide_button = True
        ...
        self.w_mat_4.saveNeeded.connect(self.emit_save)
