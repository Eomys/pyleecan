...
class Ui_WHoleMag(object):
    ...
    def retranslateUi(self, WHoleMag):
        ...
        self.c_hole_type.setItemText(
            3, QCoreApplication.translate("WHoleMag", "Slot Type 53", None)
        )
        self.c_hole_type.setItemText(
            4, QCoreApplication.translate("WHoleMag", "Slot Type 54", None)
        )
        self.c_hole_type.setItemText(
            5, QCoreApplication.translate("WHoleMag", "Slot Type 55", None)
        )
        self.c_hole_type.setItemText(
            6, QCoreApplication.translate("WHoleMag", "Slot Type 56", None)
        )
