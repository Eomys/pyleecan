...
class Gen_SWinding(Ui_SWinding):
    def setupUi(self, SWinding):
        ...
        # Setup of in_qs
        txt = self.tr("""<qt><nobr>number of phases </nobr></qt>""")
        ...
        # Setup of is_reverse
        txt = self.tr(
            """<qt><nobr>1 to reverse the default winding algorithm along the</nobr> airgap (c, b, a instead of a, b, c along the trigonometric direction)</qt>"""
        )
        ...
        # Setup of in_Nslot
        txt = self.tr(
            """<qt><nobr>Number of slots to shift the coils obtained with pyleecan</nobr> winding algorithm (a, b, c becomes b, c, a with Nslot_shift_wind=1)</qt>"""
        )
        ...
        txt = self.tr(
            """<qt><nobr>Distance (in slot) between a conductor of a certain phase</nobr> and the corresponding return conductor</qt>"""
        )
        ...
        # Setup of in_Ntcoil
        txt = self.tr("""<qt><nobr>number of turns per coil</nobr></qt>""")
        ...
        # Setup of in_Npcp
        txt = self.tr("""<qt><nobr>number of parallel circuits per phase</nobr></qt>""")
