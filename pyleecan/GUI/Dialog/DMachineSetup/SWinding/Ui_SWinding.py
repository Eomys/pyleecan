...
class Ui_SWinding(object):
    ...
    def retranslateUi(self, SWinding):
        ...
        self.out_rot_dir.setToolTip(
            QCoreApplication.translate(
                "SWinding",
                "<qt><nobr>Fundamental field rotation direction when feeding the</nobr> winding with direct AC current</qt>",
                None,
            )
        )
        ...
        self.out_Nperw.setToolTip(
            QCoreApplication.translate(
                "SWinding", "<qt><nobr>Winding periodicity</nobr></qt>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.out_Ntspc.setToolTip(
            QCoreApplication.translate(
                "SWinding",
                "<qt><nobr>Winding number of turns in series per phase</nobr></qt>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.out_Ncspc.setToolTip(
            QCoreApplication.translate(
                "SWinding",
                "<qt><nobr>Number of coils in series per parallel circuit</nobr></qt>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
