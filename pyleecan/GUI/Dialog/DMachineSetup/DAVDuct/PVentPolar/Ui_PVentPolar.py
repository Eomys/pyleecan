...
class Ui_PVentPolar(object):
    def setupUi(self, PVentPolar):
        ...
        self.img_vent.setPixmap(
            QPixmap(":/images/images/MachineSetup/LamParam/VentilationPolar.png")
        )
    ...
    def retranslateUi(self, PVentPolar):
        ...
        self.unit_W1.setText(QCoreApplication.translate("PVentPolar", "[rad]", None))
        self.in_Alpha0.setText(
            QCoreApplication.translate("PVentPolar", "Alpha0 :", None)
        )
        self.unit_Alpha0.setText(
            QCoreApplication.translate("PVentPolar", "[rad]", None)
        )
