...
# File generated according to BoreSinePole.ui
...
class Ui_BoreSinePole(object):
    def setupUi(self, BoreSinePole):
        if not BoreSinePole.objectName():
            BoreSinePole.setObjectName(u"BoreSinePole")
        BoreSinePole.resize(899, 470)
        BoreSinePole.setMinimumSize(QSize(630, 470))
        BoreSinePole.setMaximumSize(QSize(16777215, 16777215))
        self.horizontalLayout = QHBoxLayout(BoreSinePole)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.verticalLayout_2 = QVBoxLayout()
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.img_bore = QLabel(BoreSinePole)
        ...
        self.scrollArea = QScrollArea(BoreSinePole)
        ...
        self.retranslateUi(BoreSinePole)

        QMetaObject.connectSlotsByName(BoreSinePole)

    # setupUi

    def retranslateUi(self, BoreSinePole):
        BoreSinePole.setWindowTitle(
            QCoreApplication.translate("BoreSinePole", u"Form", None)
        )
        self.img_bore.setText("")
        self.in_Rarc.setText(QCoreApplication.translate("BoreSinePole", u"Rarc", None))
        self.unit_Rarc.setText(QCoreApplication.translate("BoreSinePole", u"m", None))
        self.in_alpha.setText(
            QCoreApplication.translate("BoreSinePole", u"alpha", None)
        )
        self.c_alpha_unit.setItemText(
            0, QCoreApplication.translate("BoreSinePole", u"[rad]", None)
        )
        self.c_alpha_unit.setItemText(
            1, QCoreApplication.translate("BoreSinePole", u"[deg]", None)
        )
