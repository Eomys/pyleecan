...
class Gen_PBoreSinePole(Ui_PBoreSinePole):
    def setupUi(self, PBoreSinePole):
        ...
        # Setup of in_k
        txt = self.tr("""pole width modifier""")
        ...
        # Setup of in_delta_d
        txt = self.tr("""d-axis air gap width""")
        ...
        # Setup of in_delta_q
        txt = self.tr("""q-axis air gap width""")
