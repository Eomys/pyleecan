...
class Ui_SWindParam(object):
    def setupUi(self, SWindParam):
        ...
        self.in_Npcp = QLabel(self.widget)
        self.in_Npcp.setObjectName(u"in_Npcp")
        self.in_Npcp.setMinimumSize(QSize(40, 0))

        self.horizontalLayout.addWidget(self.in_Npcp)

        self.si_Npcp = QSpinBox(self.widget)
        self.si_Npcp.setObjectName(u"si_Npcp")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.si_Npcp.sizePolicy().hasHeightForWidth())
        self.si_Npcp.setSizePolicy(sizePolicy)
        self.si_Npcp.setMinimumSize(QSize(100, 0))
        self.si_Npcp.setMaximumSize(QSize(100, 16777215))
        self.si_Npcp.setValue(99)

        self.horizontalLayout.addWidget(self.si_Npcp)
    ...
    def retranslateUi(self, SWindParam):
        ...
        self.in_Npcp.setText(QCoreApplication.translate("SWindParam", u"Npcp", None))
