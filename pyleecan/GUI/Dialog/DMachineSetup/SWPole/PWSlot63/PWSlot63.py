...
class PWSlot63(Gen_PWSlot63, QWidget):
    """Page to set the Slot Type 63"""
    ...
    def __init__(self, lamination=None):
        ...
        listView = QListView(self.c_H1_unit)
        self.c_H1_unit.setView(listView)

        self.c_H1_unit.setCurrentIndex(0)  # rad
