...
class Ui_PMSlot18(object):
    def setupUi(self, PMSlot18):
        ...
        self.img_slot.setPixmap(
            QPixmap(":/images/images/MachineSetup/WMSlot/SlotM18.png")
        )
    ...
    def retranslateUi(self, PMSlot18):
        ...
        self.unit_Hmag.setText(QCoreApplication.translate("PMSlot18", "[m]", None))
        self.in_Hmag.setText(QCoreApplication.translate("PMSlot18", "Hmag", None))
