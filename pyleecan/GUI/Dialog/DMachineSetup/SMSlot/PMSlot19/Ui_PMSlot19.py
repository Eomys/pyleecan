...
class Ui_PMSlot19(object):
    def setupUi(self, PMSlot19):
        ...
        self.img_slot.setPixmap(
            QPixmap(":/images/images/MachineSetup/WMSlot/SlotM19.png")
        )
    ...
    def retranslateUi(self, PMSlot19):
        ...
        self.unit_Hmag.setText(QCoreApplication.translate("PMSlot19", "[m]", None))
        self.in_Hmag.setText(QCoreApplication.translate("PMSlot19", "Hmag", None))
