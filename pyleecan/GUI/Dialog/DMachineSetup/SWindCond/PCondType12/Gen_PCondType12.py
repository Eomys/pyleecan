...
class Gen_PCondType12(Ui_PCondType12):
    def setupUi(self, PCondType12):
        ...
        # Setup of in_Nwpc1
        txt = self.tr(
            """<qt><nobr>number of strands in parallel per conductor</nobr></qt>"""
        )
        ...
        # Setup of in_Wwire
        txt = self.tr(
            """<qt><nobr>cf schematics, single strand diameter without</nobr> insulation</qt>"""
        )
        ...
        txt = self.tr(
            """<qt><nobr>(advanced) cf schematics, conductor diameter</nobr></qt>"""
        )
