...
class Ui_PCondType12(object):
    def setupUi(self, PCondType12):
        ...
        self.img_cond.setPixmap(
            QPixmap(u":/images/images/MachineSetup/WindParam/Cond_1_2.PNG")
        )
        ...
        self.lf_Wwire.setMaximumSize(QSize(100, 20))

        self.gridLayout.addWidget(self.lf_Wwire, 1, 1, 1, 1)

        self.unit_Wwire = QLabel(PCondType12)
        ...
        self.in_Wins_wire = QLabel(PCondType12)
        ...
        self.lf_Wins_wire.setMaximumSize(QSize(100, 20))

        self.gridLayout.addWidget(self.lf_Wins_wire, 2, 1, 1, 1)

        self.unit_Wins_wire = QLabel(PCondType12)
        ...
        self.in_Wins_cond = QLabel(PCondType12)
        ...
        self.unit_Lewout = QLabel(PCondType12)
    ...
    def retranslateUi(self, PCondType12):
        ...
        self.in_Nwpc1.setText(
            QCoreApplication.translate("PCondType12", u"Nwpc1 :", None)
        )
        self.in_Wwire.setText(
            QCoreApplication.translate("PCondType12", u"Wwire :", None)
        )
