...
class Ui_PCondType12(object):
    ...
    def retranslateUi(self, PCondType12):
        ...
        self.in_Nwpc1.setText(QCoreApplication.translate("PCondType12", "Nwppc", None))
        self.unit_Wwire.setText(QCoreApplication.translate("PCondType12", "m", None))
        self.in_Wwire.setText(QCoreApplication.translate("PCondType12", "Wwire", None))
        self.in_Wins_wire.setText(
            QCoreApplication.translate("PCondType12", "Wins_wire", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.in_Lewout.setText(
            QCoreApplication.translate("PCondType12", "Lewout", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.in_Wins_cond.setText(
            QCoreApplication.translate("PCondType12", "Wins_cond", None)
        )
