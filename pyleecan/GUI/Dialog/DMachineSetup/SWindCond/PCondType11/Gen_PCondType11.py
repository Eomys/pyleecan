...
class Gen_PCondType11(Ui_PCondType11):
    def setupUi(self, PCondType11):
        ...
        txt = self.tr(
            u"""number of form wound strands in parallel per conductor along tangential (horizontal) direction"""
        )
        ...
        txt = self.tr(
            u"""number of form wound strands in parallel per conductor along radial (vertical) direction"""
        )
