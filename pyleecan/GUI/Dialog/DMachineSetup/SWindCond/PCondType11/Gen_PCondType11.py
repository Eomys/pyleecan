...
class Gen_PCondType11(Ui_PCondType11):
    def setupUi(self, PCondType11):
        ...
        txt = self.tr(
            """<qt><nobr>number of form wound strands in parallel per conductor</nobr> along tangential (horizontal) direction</qt>"""
        )
        ...
        txt = self.tr(
            """<qt><nobr>number of form wound strands in parallel per conductor</nobr> along radial (vertical) direction</qt>"""
        )
        ...
        # Setup of in_Hwire
        txt = self.tr(
            """<qt><nobr>cf schematics, single strand height without insulation</nobr></qt>"""
        )
        ...
        # Setup of in_Wwire
        txt = self.tr(
            """<qt><nobr>cf schematics, single strand width without insulation</nobr></qt>"""
        )
        ...
        txt = self.tr(
            """<qt><nobr>(advanced) cf schematics, winding strand insulation</nobr> thickness</qt>"""
        )
