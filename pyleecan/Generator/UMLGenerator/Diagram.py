...
class Diagram():
    ...
    def __init__(self, folder_path: list,
                 name: str =None,
                 direction: str ="TB",
    ...
    def find_components(self):
        ...
        for mermaid_class in self.folder_classes_dict.values():
            ...
            for var_type in composition_list:
                if (var_type in self.folder_classes_dict and
                    var_type!=mermaid_class.name):
    ...
    def find_children(self):
        ...
        for mermaid_class in self.folder_classes_dict.values():
            ...
            if parent in self.folder_classes_dict:
                self.folder_classes_dict[parent].children_list.append(mermaid_class.name)
    ...
    def find_relevant_classes(self):
        ...
        while(current_list):
            ...
            for cls_name in current_list:
                ...
                temp_list += list(current_class.components_set) + current_class.children_list
    ...
    def generate_classes_dict(self):
        ...
        if self.parent_class_name:
            ...
            self.classes_dict = {name:self.folder_classes_dict[name] for name in classes_list}
        else:
    ...
    def save_mermaid_code(self):
        ...
        """
        file_path_to_write_code=join(self.folder_path_to_write_code,self.name +".mmd")
