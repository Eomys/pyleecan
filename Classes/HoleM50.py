# -*- coding: utf-8 -*-
"""File generated according to pyleecan/Generator/ClassesRef/Slot/HoleM50.csv
...
class HoleM50(HoleMag):
    ...
    def __str__(self):
        ...
        if self.magnet_1 is not None:
            HoleM50_str += "magnet_1 = " + str(self.magnet_1.as_dict()) + linesep + linesep
        else:
    ...
    # Type : float, min = 0
    W1 = property(
        fget=_get_W1, fset=_set_W1, doc=u"""Tooth width (at V bottom)"""
    )
    ...
    # Type : float, min = 0
    W3 = property(
        fget=_get_W3, fset=_set_W3, doc=u"""Tooth width (at V top)"""
    )
