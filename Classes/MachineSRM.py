# -*- coding: utf-8 -*-
"""File generated according to pyleecan/Generator/ClassesRef/Machine/MachineSRM.csv
...
try:
    from pyleecan.Methods.Machine.MachineSRM.check import check
except ImportError as error:
    check = error

try:
    from pyleecan.Methods.Machine.MachineSRM.get_machine_type import get_machine_type
except ImportError as error:
...
class MachineSRM(MachineSync):
    ...
    def __init__(self, rotor=-1, stator=-1, frame=-1, shaft=-1, name="default_machine", desc="", type_machine=1, init_dict=None):
        ...
        super(MachineSRM, self).__init__(rotor=rotor, stator=stator, frame=frame, shaft=shaft, name=name, desc=desc, type_machine=type_machine)
