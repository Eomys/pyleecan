...
class Elements(FrozenClass):
    """Store elements of the mesh defined by several nodes"""
    ...
    def __str__(self):
        ...
        if self.parent is None:
            Elements_str += "parent = None " + linesep
        else:
            Elements_str += "parent = " + str(type(self.parent)) + " object" + linesep
        Elements_str += "connectivity = " + linesep + str(self.connectivity) + linesep + linesep
        Elements_str += "solution_dict = " + str(self.solution_dict)
        return Elements_str
    ...
    def as_dict(self):
        ...
        if self.connectivity is None:
            Elements_dict["connectivity"] = None
        else:
            Elements_dict["connectivity"] = self.connectivity.tolist()
        Elements_dict["solution_dict"] = self.solution_dict
        # The class name is added to the dict fordeserialisation purpose
        Elements_dict["__class__"] = "Elements"
    ...
    # Dictionary contraining the FEA solution related to the elements
    # Type : dict
    solution_dict = property(fget=_get_solution_dict, fset=_set_solution_dict,
                             doc=u"""Dictionary contraining the FEA solution related to the elements""")
