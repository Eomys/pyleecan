# -*- coding: utf-8 -*-
"""File generated according to pyleecan/Generator/ClassesRef/Output/Output.csv
...
try:
    from pyleecan.Methods.Output.Output.plot.Magnetic.plot_Br_time_compare import (
...
try:
    from pyleecan.Methods.Output.Output.plot.Magnetic.plot_Br_fft2 import plot_Br_fft2
except ImportError as error:
    plot_Br_fft2 = error

try:
    from pyleecan.Methods.Output.Output.plot.Magnetic.plot_ASWL import plot_ASWL
except ImportError as error:
    plot_ASWL = error
