...
# Form implementation generated from reading ui file 'C:\Users\Raphael\Desktop\Git\PyManatee\pyleecan\GUI\Dialog\DMatLib\DMatSetup\DMatSetup.ui'
#
...
class Ui_DMatSetup(object):
    ...
    def retranslateUi(self, DMatSetup):
        ...
        self.in_type_mat.setText(_translate("DMatSetup", "Material type"))
        self.c_type_mat.setItemText(0, _translate("DMatSetup", "Raw material"))
        self.c_type_mat.setItemText(1, _translate("DMatSetup", "Magnet material"))
        self.c_type_mat.setItemText(2, _translate("DMatSetup", "Lamination material"))
