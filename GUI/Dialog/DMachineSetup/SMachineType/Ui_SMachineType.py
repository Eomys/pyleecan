...
class Ui_SMachineType(object):
    def setupUi(self, SMachineType):
        ...
        self.img_type_machine.setPixmap(QtGui.QPixmap(":/images/images/MachineSetup/SCIM.png"))
        ...
        self.txt_type_machine.setTextInteractionFlags(QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
    ...
    def retranslateUi(self, SMachineType):
        ...
        self.is_inner_rotor.setToolTip(_translate("SMachineType", "1 for internal rotor topology, 0 for external rotor"))
