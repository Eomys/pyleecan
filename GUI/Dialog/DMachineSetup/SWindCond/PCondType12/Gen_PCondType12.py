...
class Gen_PCondType12(Ui_PCondType12):
    def setupUi(self, PCondType12):
        ...
        # Setup of in_Nwpc1
        txt = self.tr(u"""cf schematics, winding number of random wires (strands) in parallel per coil""")
        ...
        txt = self.tr(u"""(advanced) cf schematics, winding coil insulation diameter [m]""")
